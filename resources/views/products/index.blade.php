    ...
    <style>
        @media (max-width: 768px) {
            ...
            .table-responsive table {
                min-width: 700px;
                /* or set a width wider than mobile screen */
            }
        }
    </style>
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" id="productsTable">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ auth()->user()->role === 'admin' ? 10 : 9 }}" class="text-center">No products
                                found.</td>
                        </tr>
                    @endforelse
                </tbody>
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (errors.file) {
                            ...
                            input.after('<div class="invalid-feedback">' + errors.file[0] +
                                '</div>');
                        }
                    }
                });
